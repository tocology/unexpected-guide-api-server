CREATE TABLE `unexpectedguide`.`art` (
...
CREATE TABLE `unexpectedguide`.`artist` (
...
CREATE TABLE `unexpectedguide`.`voice` (
...
CREATE TABLE `unexpectedguide`.`voice_log` (
...
CREATE TABLE `unexpectedguide`.`image` (
...
CREATE TABLE `unexpectedguide`.`art_image_map` (
...
CREATE TABLE `unexpectedguide`.`docent` (
...
CREATE TABLE `unexpectedguide`.`docent_log` (
...
CREATE TABLE `unexpectedguide`.`country` (
...
CREATE TABLE `unexpectedguide`.`copyright` (
